...
int ConfiguraInicializaSistema (TipoSistema *p_sistema) {
	...
	p_sistema->snakePi.p_pantalla = &(p_sistema->led_display.pantalla);
	p_sistema->snakePi.tmr_refresco_snake = tmr_new(timer_isr);
	//InicializaSnakePi(&(p_sistema->snakePi)); 	//NO HACE FALTA PORQUE LO HACEMOS EN INICIOJUEGO



	// Lanzamos thread para exploracion del teclado convencional del PC

	//LO HE COMENTADO DE MOMENTO PARA NO USAR EL TECLADO.
